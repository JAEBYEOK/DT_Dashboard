...
export default function RoutePlanning() {
  ...
  return (
    // [?àÏù¥?ÑÏõÉ ?µÏùº] Wrapper: ?§Î•∏ ?òÏù¥ÏßÄ?Ä ?ïÌôï???ôÏùº???®Îî©/?íÏù¥ ?ÅÏö©
    <div className="w-full max-w-[1920px] mx-auto p-4 lg:p-6 flex flex-col h-[calc(100vh-20px)] overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 flex-1 min-h-0">
        ...
        {/* [?ºÏ™Ω ÏßÄ???ÅÏó≠] 
            - ?ÑÏπò ?µÏùº: Ï≤?Î≤àÏß∏ Ïª¨Îüº?êÏÑú ?úÏûë
            - ?¨Í∏∞ ?†Ï?: lg:col-span-8 (?îÎ©¥??2/3 Ï∞®Ï?, Í∏∞Ï°¥ 'Wide Map' ?πÏÑ± ?†Ï?) 
        */}
        ...
        {/* [?§Î•∏Ï™??ïÎ≥¥ ?®ÎÑê] col-span-4 (?òÎ®∏ÏßÄ 1/3 Ï∞®Ï?) */}
